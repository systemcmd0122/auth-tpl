      ...
      <div className="relative min-h-screen flex items-center justify-center">
        <Card className="w-full max-w-md bg-black/50 border-purple-500/20 backdrop-blur-xl">
          <CardHeader>
            ...
            <CardTitle className="text-2xl text-center text-white">システムログイン</CardTitle>
            <CardDescription className="text-center text-purple-300">認証情報を入力してください</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="text-center text-sm">
              <span className="text-purple-300">アカウントをお持ちでない方は </span>
